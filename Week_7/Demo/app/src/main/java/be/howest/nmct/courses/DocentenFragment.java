...
public class DocentenFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        mAdapter = new DocentenAdapter(getActivity(), R.layout.cel_docent, null, columns, viewIds, 0);
    ...
    class DocentenAdapter extends SimpleCursorAdapter {

        private int layout;

        public DocentenAdapter(Context context, int layout, Cursor c, String[] from, int[] to, int flags) {
