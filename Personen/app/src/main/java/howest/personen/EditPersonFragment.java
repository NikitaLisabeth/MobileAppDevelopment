 ...
 * {@link howest.personen.EditPersonFragment.SavePersonListener} interface
...
public class EditPersonFragment extends Fragment {
    ...
    private static final String ARG_NAME = "howest.NAME";
    private static final String ARG_EMAIL = "howest.EMAIL";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            mParam2 = getArguments().getString(ARG_EMAIL);
        }
    }
