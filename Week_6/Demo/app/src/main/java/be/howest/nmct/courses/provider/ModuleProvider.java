...
public class ModuleProvider {
    ...
    private static ModuleProvider instance = new ModuleProvider();
    ...
    private void loadModules(){
       modules2NMCT = new ArrayList<>();
        ...
        appDev2NMCT.getDocentList().add(new Docent("Walcarius","Stijn","Stijn.Walcarius@howest.be"));
    ...
    public List<Docent> getDocentenModule(String sModulenaam){
